...
/**
 * The IntegrityStatisticBean class abstracts a single statistic entry within the Integrity Statistics output. It
 * has a field holding the value for each data point within each of the 14 standard columns generated in the Integrity
 * Statistics .csv file (created via the <code>im stats --csv</code> CLI command).
 *
 * Each IntegrityStatisticBean has the following fields:
 * <ul>
...
public class IntegrityStatisticBean {
    ...
    /**
     * Default constructor which creates an IntegrityStatisticBean with default values.
     */
    ...
    /**
     * Retrieves the current average value of the IntegrityStatisticBean.
     * @return (Long) The current average value of the IntegrityStatisticBean.
     */
    public Long getAverage(){ return this.average; }

    /**
     * Retrieves the current count value of the IntegrityStatisticBean.
     * @return (Long) The current count value of the IntegrityStatisticBean.
     */
    public Long getCount(){ return this.count; }

    /**
     * Retrieves the current End Date value of the IntegrityStatisticBean.
     * @return (org.joda.time.DateTime) The current End Date value of the IntegrityStatisticBean.
     */
    public DateTime getEndDate(){ return this.endDate; }

    /**
     * Retrieves the current group value of the IntegrityStatisticBean.
     * @return (String) The current group value of the IntegrityStatisticBean.
     */
    public String getGroup(){ return this.group; }

    /**
     * Retrieves the current kind value of the IntegrityStatisticBean.
     * @return (String) The current kind value of the IntegrityStatisticBean.
     */
    public String getKind(){ return this.kind; }

    /**
     * Retrieves the current maximum value of the IntegrityStatisticBean.
     * @return (Long) The current maximum value of the IntegrityStatisticBean.
     */
    public Long getMax(){ return this.max; }

    /**
     * Retrieves the current minimum value of the IntegrityStatisticBean.
     * @return (Long) The current minimum value of the IntegrityStatisticBean.
     */
    public Long getMin(){ return this.min; }

    /**
     * Retrieves the current mode value of the IntegrityStatisticBean.
     * @return (Long) The current mode value of the IntegrityStatisticBean.
     */
    public String getMode(){ return this.mode; }

    /**
     * Retrieves the current name value of the IntegrityStatisticBean.
     * @return (Long) The current name value of the IntegrityStatisticBean.
     */
    public String getName(){ return this.name; }

    /**
     * Retrieves the current Start Date value of the IntegrityStatisticBean.
     * @return (org.joda.time.DateTime) The current Start Date value of the IntegrityStatisticBean.
     */
    public DateTime getStartDate(){ return this.startDate; }

    /**
     * Retrieves the current sum value of the IntegrityStatisticBean.
     * @return (Long) The current sum value of the IntegrityStatisticBean.
     */
    public Long getSum(){ return this.sum; }

    /**
     * Retrieves the current total count value of the IntegrityStatisticBean.
     * @return (Long) The current totcal count value of the IntegrityStatisticBean.
     */
    public Long getTotalCount(){ return this.totalCount; }

    /**
     * Retrieves the current unit value of the IntegrityStatisticBean.
     * @return (String) The current unit value of the IntegrityStatisticBean.
     */
    public String getUnit(){ return this.unit; }

    /**
     * Retrieves the current average value of the IntegrityStatisticBean.
     * @return (String) The current average value of the IntegrityStatisticBean.
     */
    public String getUsed(){ return this.used; }

    /**
     * Prints the IntegrityStatisticBean's fields to the system console.
    ...
    /**
     * Sets the value of the average field for the IntegrityStatisticBean.
    ...
    /**
     * Sets the value of the count field for the IntegrityStatisticBean.
    ...
    /**
     * Sets the value of the endDate field for the IntegrityStatisticBean.
    ...
    /**
     * Sets the value of the min field for the IntegrityStatisticBean.
    ...
    /**
     * Sets the value of the name field for the IntegrityStatisticBean.
    ...
    /**
     * Sets the value of the start date field for the IntegrityStatisticBean.
    ...
    /**
     * Sets the value of the sum field for the IntegrityStatisticBean.
    ...
    /**
     * Sets the value of the total count field for the IntegrityStatisticBean.
    ...
    /**
     * Sets the value of the unit field for the IntegrityStatisticBean.
     * @param arg_unit - (String) value to assign to the unit field.
     */
    public void setUnit(String arg_unit){ this.unit = arg_unit; }

    /**
     * Sets the value of the used field for the IntegrityStatisticBean.
